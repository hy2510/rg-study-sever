function getLanguage(pText) {
    ...
    switch (pText) {
        ...
        case "(주의) 모든학습을 완료하고 평균 70점을 넘어야 포인트를 획득할 수 있습니다.":
            if (gvLanguage == "KOR") usermsg = pText;
            else if (gvLanguage == "ENG") usermsg = "(!) You must complete all steps with an average of 70% to earn full points.";
            else if (gvLanguage == "CHN") usermsg = "(!) You must complete all steps with an average of 70% to earn full points.";
            else if (gvLanguage == "JPN") usermsg = "(!) You must complete all steps with an average of 70% to earn full points.";
            else if (gvLanguage == "VTN") usermsg = "(Chú ý) Bạn cần làm hết After Reading và đạt trung bình từ 70 điểm trở lên để nhận được điểm đọc sách tương ứng.";
            else if (gvLanguage == "INE") usermsg = "(!) You must complete all steps with an average of 70% to earn full points.";
            break;
